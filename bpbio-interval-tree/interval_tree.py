...
class IntervalTree(object):
    __slots__ = ('intervals', 'left', 'right', 'center', 'depth', 'minbucket', 'extent', 'maxbucket')
    ...
    def __init__(self, intervals, depth=16, minbucket=64, _extent=None, maxbucket=512):
        ...
        # Make sure we have all of these set consistently for use with the "add" method.
        self.depth = depth
    ...
    def add(self, intervals, depth=16, minbucket=64, _extent=None, maxbucket=512):
       for interval in intervals:
            if interval.stop < center:
                lefts.append(interval)
            elif interval.start > center:
